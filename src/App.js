        ...
        <Route exact path='/' render={() => (
          <div className="list-books">
            ...
            <div className="list-books-content">
              <div>
                <Bookshelf shelfTitle="Currently Reading" books={this.state.books.filter((b) => b.shelf === 'currentlyReading')}/>
                <Bookshelf shelfTitle="Want to Read" books={this.state.books.filter((b) => b.shelf === 'wantToRead')}/>
