        ...
        <Route exact path='/' render={() => (
          <div className="list-books">
            ...
            <div className="list-books-content">
              <div>
                <Bookshelf shelfTitle="Currently Reading" books={this.state.books.filter((b) => b.shelf === 'currently-reading')}/>
                <Bookshelf shelfTitle="Want to Read" books={this.state.books.filter((b) => b.shelf === 'want-to-read')}/>
                <Bookshelf shelfTitle="Read" books={this.state.books.filter((b) => b.shelf === 'read')}/>                
              </div>
            </div>
